...
namespace Scripts.Mythik
{
    class MythikStaticValues
    {
        ...
        public static Point3D NeutralZone = new Point3D(5182,1259, 0);

        public static Point3D[] Mall = new Point3D[] { new Point3D(5317, 2261, 0), new Point3D(5317, 2241, 0), new Point3D(5317, 2221, 0) };

        public static Point3D ArenaOneVOne = new Point3D(5143,2173, 0);

        public static Point3D ArenaFFA = new Point3D(5202,2133, 0);
        public static Point3D ArenaBoxing = new Point3D(5161,2227, 0);
        ...
        internal static bool UpdateLoc(ref int x, ref int y, ref Map map)
        {
            var point = new Point3D(x, y, 0);
            var res = UpdateLoc(ref point, ref map);
            x = point.X;
            y = point.Y;
            return res;
        }
