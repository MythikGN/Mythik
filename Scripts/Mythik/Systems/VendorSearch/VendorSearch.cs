...
namespace Server.Engines.VendorSearhing
{
	public class VendorSearch
	{
        ...
        {
            CommandSystem.Register("vsearch", AccessLevel.Player, OpenVendorSearch);
            ...
            Timer.DelayCall(TimeSpan.FromSeconds(1), () =>
                {
                    ...
                    combat.Register(new object[] { AosAttribute.WeaponDamage, AosAttribute.DefendChance, AosAttribute.AttackChance, AosAttribute.WeaponSpeed,  
                                                       AosWeaponAttribute.UseBestSkill,  /*TODO: Assassin Honed*/"SearingWeapon", 
                                                       "BalancedWeapon", });

                    casting.Register(new object[] {  AosAttribute.SpellDamage, AosAttribute.CastRecovery, AosAttribute.CastSpeed,
                    ...
                    hitspell.Register(new object[] { AosWeaponAttribute.HitDispel, AosWeaponAttribute.HitFireball, AosWeaponAttribute.HitHarm,  AosWeaponAttribute.HitLeechHits,
                                                         ...
                                                         AosWeaponAttribute.HitLeechMana, AosWeaponAttribute.HitLeechStam});
                    ...
                    slayer2.Register(new object[] { SlayerName.Repond, TalismanSlayerName.Bear, TalismanSlayerName.Beetle, TalismanSlayerName.Bird, TalismanSlayerName.Bovine, TalismanSlayerName.Flame,  TalismanSlayerName.Ice, 
                                                        TalismanSlayerName.Mage, SlayerName.OgreTrashing, SlayerName.OrcSlaying, SlayerName.TrollSlaughter, TalismanSlayerName.Vermin });
        ...
        [Usage("vsearch")]
        [Description("Open the vendor search gump.")]
        private static void OpenVendorSearch(CommandEventArgs e)
        {
            var Player = e.Mobile as PlayerMobile;

            if (Player != null && VendorSearch.CanSearch(Player))
            {
                Player.SendGump(new VendorSearchGump(Player));
            }
            else
            {
                e.Mobile.SendAsciiMessage("You cannot vendor search at this time.");
            }
        }
    ...
    public class SearchCategory
    {
        ...
        public void Register(object o)
        {
            if (Objects.FirstOrDefault(t => t.Item1 == o) == null)
                Objects.Add(new Tuple<object, int>(o, RunicReforging.GetAttributeName(o)));
        }
        ...
        public void Register(object[] o)
        {
            ...
            {
                if (Objects.FirstOrDefault(t => t.Item1 == o) == null)
                    Objects.Add(new Tuple<object, int>(obj, RunicReforging.GetAttributeName(obj)));
            }
        }
