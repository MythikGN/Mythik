    ...
    public class LanguageAndSkillsSelect
    {
        ...
        private class LanguageSelectGump : Gump
        {
            public LanguageSelectGump(): base(25,25)
            {
                ...
                this.AddHtml(43, 79, 230, 100, @"Please select your language so we can<BR> localize text to your native language", (bool)false, (bool)false);
                this.AddGroup(1);
                this.AddRadio(60, 160, 209, 208, true, 2);
                this.AddRadio(60, 180, 209, 208, false, 3);
                this.AddRadio(60, 200, 209, 208, false, 4);
                this.AddRadio(60, 220, 209, 208, false, 5);
                this.AddRadio(60, 240, 209, 208, false, 6);
