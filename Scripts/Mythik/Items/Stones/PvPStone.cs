...
namespace Scripts.Mythik.Items.Stones
{
    public class PvpStone : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            reags.DropItem(new TotalManaPotion() { Amount = 25 });
            reags.DropItem(new GreaterHealPotion() { Amount = 25 });
            reags.DropItem(new InvisibilityPotion() { Amount = 25 });
            reags.DropItem(new GreaterCurePotion() { Amount = 10 });
            reags.DropItem(new GreaterRestorePotion() { Amount = 25 });
