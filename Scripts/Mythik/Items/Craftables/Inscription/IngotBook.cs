...
namespace Scripts.Mythik.Items.Craftables.Inscription
{
    ...
    {
        Dictionary<Type, ResourceStub> StoredItems { get; }
    }
    public class IngotBook : Item , ResourceBook
    {
        ...
        private Type m_StorageType = typeof(BaseIngot);
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            else if (dropped is Container)
            {
                ...
                for (int i = 0; i < container.Items.Count; ++i)
                {
                    ...
                    {
                        if ((added = AddResource(from, (BaseIngot)item, true)))
                            toDelete.Add(item);
                    }
                }
